              ...
              <div>
                ...
                <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-xs text-blue-500">
                    🛡️ <strong>Защита от фрода:</strong> Требования 10 дней игры и трат 1 млн монет помогают нам убедиться, что вы настоящий игрок, который серьёзно относится к игре, а не случайный посетитель.
                  </p>
                </div>
              </div>
            </div>
